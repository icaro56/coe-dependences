...
namespace OgreAL {
	...
	public:
		...
		*/
		 ...
		 */
		void setGainScale(Ogre::Real gainScale);
		/**
		 ...
		 */
		void setGainValues(Ogre::Real maxGain, Ogre::Real minGain, 
				   Ogre::Real gain, Ogre::Real gainScale = 1.0);
		/**
