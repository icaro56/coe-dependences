...
{   
     ...
     * stored elsewhere.
     */
    class OGREMAX_EXPORT OgreMaxRenderWindowIterator
    {
    public:
    ...
    class OGREMAX_EXPORT OgreMaxOneRenderWindow : public OgreMaxRenderWindowIterator
    {
    public:
    ...
    class OGREMAX_EXPORT OgreMaxRenderWindowArray : public OgreMaxRenderWindowIterator
    {
    public:
    ...
    class OGREMAX_EXPORT OgreMaxRenderWindowCollection : public OgreMaxRenderWindowIterator
    {
    public:
