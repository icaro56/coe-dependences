...
namespace Forests
{
   ...
   class PAGEDGEOMETRY_EXPORT ImpostorPage: public GeometryPage
   {
   ...
   class PAGEDGEOMETRY_EXPORT ImpostorBatch
   {
   public:
   ...
   class PAGEDGEOMETRY_EXPORT ImpostorTextureResourceLoader : public Ogre::ManualResourceLoader
   {
   public:
      /**
      *    Ctor.
   ...
   //flat billboards.
   class PAGEDGEOMETRY_EXPORT ImpostorTexture
   {
