...
set(Qt5WebKit_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/QtWebKit/${Qt5WebKit_VERSION_STRING}"
        "${_qt5WebKit_install_prefix}/include/QtWebKit/${Qt5WebKit_VERSION_STRING}/QtWebKit"
    )
    ...
    foreach(_module_dep ${_Qt5WebKit_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5WebKit_VERSION_STRING} ${_Qt5WebKit_FIND_VERSION_EXACT}
    ...
    if (Qt5WebKit_EXECUTABLE_COMPILE_FLAGS)
